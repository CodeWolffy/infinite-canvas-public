export default {
    ...
    settingsPanels: {
        common: { auto: "Auto", low: "Low", medium: "Medium", high: "High", xhigh: "Extra high", max: "Maximum", ultra: "Ultra" },
    ...
    imageReferences: { label: "Image {{index}}", promptLabel: "Image {{index}} (Img {{index}} / 图{{index}})", separator: ", ", promptPrefix: "Reference image labels and aliases: {{labels}}. Use these labels to interpret image references in the prompt.\n\n{{prompt}}" },
    modelPlugin: {
    ...
    assets: {
        ...
        kinds: { text: "Text", image: "Image", video: "Video", audio: "音频" },
        fields: {
            title: "Title",
    ...
    imageWorkbench: {
        ...
        batchInProgress: "{{count}} batches running",
        runningTabTitle: "({{count}}) Generating images",
        completedTabTitle: "✓ Images generated",
        notificationTitle: "Images generated",
        retryFailed: "Retry failed ({{count}})",
        downloadAll: "Download all",
        zipDownloaded: "Downloaded {{count}} images in this batch",
        noModelHint: "No image models available. Ask an administrator to publish and enable one under Platform Admin → Models.",
    },
    videoWorkbench: {
        title: "Video Studio",
    ...
    canvas: {
        ...
        history: {
            ...
            notePlaceholder: "Snapshot note (e.g. final proposal, pre-refactor backup)",
            restore: "Restore",
            restoreConfirmTitle: "Restore this version?",
            restoreConfirm: "Are you sure you want to restore to this version? Unsaved changes may be overwritten.",
            restoreSuccess: "Successfully restored to history version",
        ...
        save: {
            ...
            blocked: "Save failed, click to retry",
            retry: "Retry save",
            retryTip: "Canvas changes are not saved to the server: {{message}}",
        },
    ...
    announcement: {
        ...
        confirm: "Got it",
        editorTitle: "Announcement Manager",
        save: "Publish",
        cancel: "Cancel",
        clearAll: "Clear All",
        clearConfirmTitle: "Clear all announcements and changelog entries?",
        clearConfirmDesc: "After publishing empty content, the announcement banner and changelog will be removed from users' view.",
        publishSuccess: "Announcement published",
        clearSuccess: "Announcement cleared",
        saveFailed: "Failed to save announcement",
        noticeTitlePlaceholder: "Announcement title (leave blank for default)",
        noticeContentPlaceholder: "Markdown supported:\n## Heading\n- List item\n**Bold**, `code`, [link](https://example.com)\n> Highlighted callout box\n```js\n// Code block\n```",
        noticeHelp: "Supports # headings, - lists, **bold**, `code`, ```code blocks, [links](url), ![images](url), > callouts, and --- dividers. Publish empty content to remove.",
        modeEdit: "Edit",
        modePreview: "Preview",
        ...
        entryTitlePlaceholder: "Update title",
        entryBodyPlaceholder: "Update description, supports Markdown (optional)",
        changelogHelp: "Tags 'new', 'update', and 'fix' display in green, blue, and amber. Other tags display in grey. Maximum 30 entries.",
        forceAlertLabel: "Re-alert all users",
        forceAlertTooltip: "Force updates the published timestamp to trigger popups and unread indicators for all users even if content hasn't changed.",
        userPreview: "Preview",
    },
    userCenter: {
        title: "User Center",
        ...
        generationsTitle: "Generation History & Asset Archival",
        generationsDesc: "View all your generation batches. Temporary images expire automatically; save them to your assets to keep them permanently.",
        retentionHint: "Temporary files are kept for {{days}} days by default. Images saved to your assets or used on a canvas will be preserved permanently.",
        savedPermanent: "Saved Permanently",
        expiresInDays: "{{days}} days left",
        expiresToday: "Expires today",
        saveToAsset: "Save to Assets",
        saveBatchToAsset: "Save All to Assets",
        remixPrompt: "Remix in Workbench",
        saveAllToAsset: "Save All to Assets",
        savingAll: "Saving all...",
        saveAllSuccess: "Batch saved successfully ({{count}} images)",
        saveAllPartial: "Saved {{count}} images, {{failed}} failed",
        saveAllFailed: "Batch save failed",
        saveFailedToAsset: "Save failed",
        allAlreadySaved: "Every image in this batch is already in your assets",
        generatedAssetTitle: "Generated image",
        batchCounts: "{{total}} images · {{succeeded}} succeeded",
        viewDetail: "View details",
        previewMask: "Click to preview",
        downloadAllImages: "Download all images",
        downloadEmpty: "This batch has no downloadable images",
        downloadZipFailed: "Failed to build the zip",
        deleteBatchSuccess: "Generation record deleted",
        deleteBatchFailed: "Delete failed",
        taskFailedReason: "Generation failed: {{reason}}",
        unknownError: "Unknown error",
        searchPromptPlaceholder: "Search prompts...",
        filterStatusAll: "All Statuses",
        filterStatusTemporary: "⏳ Temporary",
        filterStatusPermanent: "✨ Saved Permanently",
        filterStatusExpiring: "⚠️ Expiring Soon",
        storageComposition: "Storage Health & Breakdown",
        storageHealthyTip: "You have {{tempCount}} temporary generation files. We recommend saving important creations to My Assets.",
        storagePermanentRatio: "Permanent Assets Ratio",
        saving: "Saving...",
        savedSuccess: "Saved to My Assets successfully",
        deleteBatch: "Delete Batch",
        deleteBatchConfirm: "Are you sure you want to delete this generation batch?",
        deleteBatchDesc: "Deleting this record will not affect images already saved to your assets or canvas.",
        emptyGenerations: "No generation records yet",
        goToGenerate: "Generate Images",
        taskQueued: "Queued",
        taskRunning: "Generating",
        taskSucceeded: "Success",
        taskFailed: "Failed",
        taskCanceled: "Canceled",
        statsTitle: "Personal Usage Overview",
        statsDesc: "Real-time statistics of your image generations, text chats, storage footprint, and creative assets.",
        cardImages: "Total Images Generated",
        cardImagesSub: "Success {{succeeded}} / Failed {{failed}}",
        cardStorage: "Storage Footprint",
        cardStorageSub: "{{count}} media files in total",
        cardText: "Text Chat Requests",
        cardTextSub: "{{succeeded}} successful calls",
        cardAssets: "Assets & Canvases",
        cardAssetsSub: "{{assets}} assets · {{canvases}} canvases",
        successRate: "Generation Success Rate",
        logsTitle: "Personal Request Logs",
        logsDesc: "View your personal API request history to troubleshoot errors and inspect latency.",
        ...
        colError: "Error Details",
        copyError: "Copy Error",
        errorCopied: "Error details copied",
        accountTitle: "Account & Security",
        accountDesc: "Manage your profile information and credentials.",
        username: "Username",
