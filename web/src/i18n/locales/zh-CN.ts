export default {
    ...
    settingsPanels: {
        common: { auto: "自动", low: "低", medium: "中", high: "高", xhigh: "极高", max: "极致", ultra: "超强" },
    ...
    assets: {
        title: "我的资产",
        description: "收藏文本、图片、视频和音频，按类型、标题和标签快速查找。",
    ...
    imageWorkbench: {
        ...
        addReference: "加入参考图",
        batchInProgress: "{{count}} 个批次进行中",
        runningTabTitle: "（{{count}}）图片生成中",
        completedTabTitle: "✓ 图片生成完成",
        notificationTitle: "图片生成完成",
        retryFailed: "重试失败项 ({{count}})",
        downloadAll: "打包下载",
        zipDownloaded: "已下载本批次 {{count}} 张图片",
        noModelHint: "暂无可用图片模型，请联系管理员在「平台管理 → 模型管理」发布并启用模型",
    },
    videoWorkbench: {
        title: "视频创作台",
    ...
    canvas: {
        ...
        history: {
            title: "版本历史",
            createSnapshot: "创建快照",
            notePlaceholder: "输入快照备注（例如：方案A定稿、大改前备份）",
            restore: "还原",
            restoreConfirmTitle: "确认还原此版本？",
            restoreConfirm: "确定还原到该历史版本吗？当前未保存的修改可能会被覆盖。",
            restoreSuccess: "已成功还原到历史版本",
            restoreFailed: "还原历史版本失败",
    ...
    announcement: {
        ...
        cancel: "取消",
        clearAll: "一键清空",
        clearConfirmTitle: "确定要清空所有公告与更新日志吗？",
        clearConfirmDesc: "清空并发布后，用户端将撤下当前公告与更新日志。",
        publishSuccess: "公告已发布",
        clearSuccess: "公告已清空",
        saveFailed: "公告保存失败",
        noticeTitlePlaceholder: "公告标题，留空则显示默认标题",
        noticeContentPlaceholder: "支持 Markdown：\n## 小标题\n- 列表项\n**加粗**、`代码`、[链接](https://example.com)\n> 重点提示会显示为高亮框\n```js\n// 代码块\n```",
        noticeHelp: "支持 # 标题、- 列表、**加粗**、`代码`、```代码块、[链接](url)、![图片](url)、> 高亮框、--- 分割线。清空内容并发布即可撤下公告。",
        modeEdit: "编辑",
        modePreview: "预览",
        previewEmpty: "暂无内容",
        addEntry: "新增更新记录",
        ...
        entryTitlePlaceholder: "更新标题",
        entryBodyPlaceholder: "更新说明，支持 Markdown（可留空）",
        changelogHelp: "标签 new / update / fix 会显示为绿 / 蓝 / 橙色，其他标签显示为灰色。最多 30 条。",
        forceAlertLabel: "重新提醒全员",
        forceAlertTooltip: "即使公告内容未做大幅修改，也强制更新发布时间戳，让所有用户重新收到弹窗与红点提醒。",
        userPreview: "效果预览",
    },
    userCenter: {
        title: "个人中心",
        ...
        generationsTitle: "生图历史与资产归档",
        generationsDesc: "查看您发起的所有生图任务。临时图片到期后将自动清理，建议及时转存至素材库永久保存。",
        retentionHint: "平台临时文件默认保留 {{days}} 天，已转存至素材库或画布引用的图片将永久保留。",
        savedPermanent: "已永久保存",
        expiresInDays: "剩余 {{days}} 天过期",
        expiresToday: "今日到期",
        saveToAsset: "转存至素材库",
        saveBatchToAsset: "全部转存",
        remixPrompt: "在工作台中重用",
        saveAllToAsset: "整批转存至素材库",
        savingAll: "整批转存中...",
        saveAllSuccess: "整批转存完成，已保存 {{count}} 张图片",
        saveAllPartial: "已保存 {{count}} 张，{{failed}} 张转存失败",
        saveAllFailed: "整批转存失败",
        saveFailedToAsset: "转存失败",
        allAlreadySaved: "该批次所有图片已保存在素材库中",
        generatedAssetTitle: "生图素材",
        batchCounts: "共 {{total}} 张 · 成功 {{succeeded}}",
        viewDetail: "查看详情",
        previewMask: "点击放大预览",
        downloadAllImages: "下载全部图片",
        downloadEmpty: "该批次没有可下载的图片",
        downloadZipFailed: "打包下载失败",
        deleteBatchSuccess: "已删除该条生图记录",
        deleteBatchFailed: "删除失败",
        taskFailedReason: "生成失败：{{reason}}",
        unknownError: "未知错误",
        searchPromptPlaceholder: "搜索提示词关键词...",
        filterStatusAll: "全部状态",
        filterStatusTemporary: "⏳ 临时保留",
        filterStatusPermanent: "✨ 已永久保存",
        filterStatusExpiring: "⚠️ 即将到期",
        storageComposition: "存储健康度与构成",
        storageHealthyTip: "您有 {{tempCount}} 个临时生成文件。建议将重要创作及时「转存至素材库」永久留存。",
        storagePermanentRatio: "永久资产占比",
        saving: "转存中...",
        savedSuccess: "已成功转存至我的素材库",
        deleteBatch: "删除记录",
        deleteBatchConfirm: "确定要删除这条生图记录吗？",
        deleteBatchDesc: "删除后不会影响已转存到素材库或画布中的图片。",
        emptyGenerations: "暂无生图记录",
        goToGenerate: "去生成图片",
        taskQueued: "排队中",
        taskRunning: "生成中",
        taskSucceeded: "成功",
        ...
        taskCanceled: "已取消",
        statsTitle: "个人用量概览",
        statsDesc: "实时统计您的生图产出、文本对话、存储空间占用与创作资产。",
        cardImages: "生图总数",
        cardImagesSub: "成功 {{succeeded}} / 失败 {{failed}}",
        cardStorage: "存储空间占用",
        cardStorageSub: "共 {{count}} 个媒体文件",
        cardText: "文本对话调用",
        cardTextSub: "成功 {{succeeded}} 次",
        cardAssets: "素材与画布",
        cardAssetsSub: "{{assets}} 个素材 · {{canvases}} 个画布",
        successRate: "生图成功率",
        logsTitle: "个人调用日志",
        logsDesc: "查看您个人的 API 请求记录，便于排查失败原因与分析耗时。",
        filterAllType: "全部类型",
